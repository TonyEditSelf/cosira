...
const MOODS = {
  ...
  "Neon Cyber": {
    ...
    hues: [[120, 160], [175, 200], [230, 260], [300, 340]],
    chroma: [0.22, 0.38],
    lightness: [0.5, 0.75],
    accent: "#39FF14",
    count: 5,
  ...
  "Vintage & Retro": {
    ...
    hues: [[20, 45], [50, 82], [95, 118], [170, 192]],
    chroma: [0.07, 0.17],
    lightness: [0.38, 0.62],
    accent: "#C9943A",
    count: 5,
